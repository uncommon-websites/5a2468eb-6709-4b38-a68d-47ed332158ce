            ...
            <div class="md:col-span-6 md:col-start-7">
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-primary-600 mt-1.5 flex-shrink-0"></div>
                        <p class="text-gray-600 text-sm leading-relaxed font-light">
                            <span class="font-bold">Preventive measures</span> – Vegetation management surrounding property
                        </p>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-primary-600 mt-1.5 flex-shrink-0"></div>
                        <p class="text-gray-600 text-sm leading-relaxed font-light">
                            <span class="font-bold">Satellite connectivity</span> for reliable communication
                        </p>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-primary-600 mt-1.5 flex-shrink-0"></div>
                        <p class="text-gray-600 text-sm leading-relaxed font-light">
                            <span class="font-bold">Self-sufficiency</span> using backup utilities including reserved gas, water, and power
                        </p>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-primary-600 mt-1.5 flex-shrink-0"></div>
                        <p class="text-gray-600 text-sm leading-relaxed font-light">
                            <span class="font-bold">Delivery timeline</span> from factory to site within <span class="font-bold">6 months</span> vs conventional construction of 1-2 years
                        </p>
                    </div>
                    <div class="flex items-start gap-3">
                        <div class="w-2 h-2 bg-primary-600 mt-1.5 flex-shrink-0"></div>
                        <p class="text-gray-600 text-sm leading-relaxed font-light">
                            <span class="font-bold">Costs may be 20% less</span> than conventional construction
                        </p>
                    </div>
                </div>
